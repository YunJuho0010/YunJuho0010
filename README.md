...
<!-- skills starts -->
• 클라이언트/서버 최적화 — 클라이언트/서버/패킷 최적화<br>• 네트워크 프로그래밍 — C++ MMORPG 서버, Steam P2P<br>• 데이터 관리 — MySQL, Google 소셜 로그인<br>• 수익화 시스템 — RevenueCat 인앱결제, Admob 인앱광고<br>• 라이브 서비스 — 1년간 MMORPG 운영·유지보수·고객지원<br>• 협업 — 타 직군과의 협업 다수, 다양한 게임잼/해커톤 참여<br>• AI 활용 — 3D 메시 생성, 모션캡쳐, 랜딩/전적조회 사이트 제작
<!-- skills ends -->
...
<!-- activities starts -->
• 넥슨코리아 커리어 캠프 '메토링' 4기 수료 (우수상)<br>• 넥슨코리아 메이플스토리 해커톤 '메커톤' 1기 수료<br>• 넥슨코리아 대학생 게임잼 '재밌넥' 3기 수료<br>• 광운대학교 게임제작 동아리 LEVEL UP<br>• 광운대학교 47대 총학생회 비상대책위원회 위원<br>• 광운대학교 정보융합학부 19학번 학년대표<br>• 인디사이드 게임 제작 대회 금상<br>• 멘사코리아 개발자 시그 '모개숲' 회원<br>• 한국 게임메이커 커뮤니티 'KGMC' STAFF<br>• 육군 안전문화 창작물 공모전 대상 (육군참모총장상)
<!-- activities ends -->
</td>
</tr>
</table>
